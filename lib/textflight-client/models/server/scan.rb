...
module TFClient::Models::Server
  ...
  class Scan < Response
    ...
    def initialize(lines:)
      ...
      values_hash = hash_from_line_values(line: ship_line)
      ...
      LINE_IDENTIFIERS.each do |line_id|
        ...
        var_name = snake_case_sym_from_string(string: line_id)
        class_name = camel_case_from_string(string: line_id)
        ...
        if ["Owner", "Outfit space", "Shield charge"].include?(line_id)
          ...
          if var.is_a?(TFClient::Models::Server::Outfits)
